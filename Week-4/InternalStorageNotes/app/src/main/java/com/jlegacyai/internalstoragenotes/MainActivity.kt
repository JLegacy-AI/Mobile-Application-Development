package com.jlegacyai.internalstoragenotes
...
import com.jlegacyai.internalstoragenotes.ui.theme.InternalStorageNotesTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun loadNote(context: Context): String {
        return try {
            val note = openFileInput(filename).bufferedReader().use { it.readText() }
            Toast.makeText(context,"Note: Load Successfully", Toast.LENGTH_SHORT).show()
            note
        } catch (e: Exception) {
            ""
        }
